...
//    private static String baseProjectPath = "F:\\123";
    //TODO 修改自己需要的包名
    private static String basePackage = "com.example.demo";
    /**
     * 作者
     */
    private static String authorName = "manzp0329";
    //TODO 要生成的表名
    private static String[] tables = {"tb_department", "tb_user"};
//    private static String[] tables = {"tb_vpn"};
    /**
     * table前缀
     */
    ...
    //TODO 修改为自己DB设置
    private static String url = "jdbc:mysql://localhost:3306/zdk_travel_datas_syn?serverTimezone=GMT%2B8";
